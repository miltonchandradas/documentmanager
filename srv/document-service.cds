...
service DocumentService {
    ...
    action listCloudALMDocuments()                                                                                                                         returns String;
    action uploadCloudALMDocument(title: String, projectId: String, content: String, documentTypeCode: String, statusCode: Integer, priorityCode: Integer) returns String;
}
